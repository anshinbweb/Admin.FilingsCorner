                            ...
                            <div className="navbar-brand-box horizontal-logo">
                                <Link to="/" className="logo logo-dark">
                                    <span className="logo-sm">
                                        <img src={`${process.env.REACT_APP_API_URL_COFFEE}/${adminData?.data?.Logo}`} alt="" height="22" />
                                    </span>
                                    <span className="logo-lg">
                                        <img src={`${process.env.REACT_APP_API_URL_COFFEE}/${adminData?.data?.Logo}`} alt="" height="17" />
                                    </span>
                                </Link>
